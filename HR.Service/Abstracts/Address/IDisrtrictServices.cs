...
{
    public interface IDisrtrictServices
    {
        public Task<List<District>> GetDistrictListAsync();

        public Task<District> GetctDistriById(int id);
        public Task<bool> IsDistrictIdExist(int DistrictId);
