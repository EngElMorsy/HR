...
namespace HR.Infrustructure.Migrations
{
    ...
    [Migration("20230710224954_CrtEditName")]
    partial class CrtEditName
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MG_HR.DATA.Entity.Address.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MG_HR.DATA.Entity.Address.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MG_HR.DATA.Entity.Address.District", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HR.Data.Entities.EmployeeData.Employee", b =>
                {
                    ...
                    b.HasOne("MG_HR.DATA.Entity.Address.District", "District")
                        .WithMany()
            ...
            modelBuilder.Entity("MG_HR.DATA.Entity.Address.City", b =>
                {
                    b.HasOne("MG_HR.DATA.Entity.Address.Country", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("MG_HR.DATA.Entity.Address.District", b =>
                {
                    b.HasOne("MG_HR.DATA.Entity.Address.City", "City")
                        .WithMany()
